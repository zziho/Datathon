...
&#128155; 박지호 : 이번 기회에 처음으로 큰 데이터로 깊게 프로젝트를 진행해 보았는데 전처리 과정과 EDA과정에 대해서 재미를 느끼고 많이 배우게 된 뜻깊은 시간이 되었다. 조원들 덕분에 많이 배우고 데이터 이해에 대한 시각도 넓어졌음. 프로젝트를 재미있게 진행할 수 있었던 가장 큰 이유는 바로 커뮤니케이션 능력이 다들 너무 좋았다는 점이다. 커뮤니케이션 능력이 중요하다는 점 역시 몸소 느끼게 되었다. 우리조 커뮤니케이션 능력 최고 !!
